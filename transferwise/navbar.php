            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        ?>
                        <!-- <li>
                            <a class="dropdown-item d-flex justify-content-between" href="product_categories.php?cat=Accessories">
                                Accessories
                                <i class="fa fa-headphones" aria-hidden="true"></i>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex justify-content-between" href="product_categories.php?cat=Digital Devices">
                                Digital Devices <i class="fa fa-television" aria-hidden="true"></i>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex justify-content-between" href="product_categories.php?cat=Fashion">
                                Fashion
                                <i class="fa fa-shopping-bag" aria-hidden="true"></i>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex justify-content-between" href="product_categories.php?cat=Furniture">
                                Furniture
