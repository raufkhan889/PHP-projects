...
// for error messages 
if (!empty($_GET['err_fname'])) {
    $err_fname = $_GET['err_fname'];
    $empty = true;
}
if (!empty($_GET['err_lname'])) {
    $err_lname = $_GET['err_lname'];
    $empty = true;
}
...
<body>
    <div class="container">
        <h1>Sign Up</h1>
        <form action="sign_up_server.php" method="GET">
            <div class="row">
            ...
            <p class="err-msg">
                <?php
                if ($empty)
                    echo "$err_fname $err_lname $err_email $err_pwd is required";
